    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Tambahakan Data Faskes</h3>
            ...
            <div class="card-body">
                ...
                <?php
                echo form_open(base_url('index.php/admin/faskes/save'));
                $id_faskes->jumlah = $id_faskes->jumlah + 1;
                ?>
                <div class="form-group row">
                    <!-- <label class="col-4 col-form-label" for="nama_faskes">ID Faskes</label> -->
                    <div class="col-8">
                        <div class="input-group">
                            <input id="id_faskes" value="<?= $id_faskes->jumlah ?>" name="id_faskes" type="text" class="form-control" required="required" hidden>
                        </div>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-8">
                        <div class="input-group">
                            ...
                            <input id="nama_faskes" name="nama_faskes" type="text" class="form-control" required="required">
                        </div>
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    <label for="rating" class="col-4 col-form-label">Koodinat Lokasi</label>
                    <div class="col-8">
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <div class="input-group-text">
